...
public class UserCenterRedisUtil {
	private static final Log log = LogFactory.getLog(UserCenterRedisUtil.class);
	...
	private static void redisPoolInit() {
		...
		try {
			String[] redis_master_hosts = REDIS_CONFIG.getString("usercenter_redis_master_hosts").split("#");
			String[] redis_master_ports = REDIS_CONFIG.getString("usercenter_redis_master_ports").split("#");
			String[] redis_slave_hosts = REDIS_CONFIG.getString("usercenter_redis_slave_hosts").split("#");
			String[] redis_slave_ports = REDIS_CONFIG.getString("usercenter_redis_slave_ports").split("#");
			...
			log.info("usercenter build jedisPool_master...");
    ...
    public static void main(String[] args){
    	System.out.println("122".matches("[a-zA-Z]{2,16}"));
    	String uid = "032222f2760d4442afe83109def88a6a";
    	ShardedJedisPool jedispool = getJedisPoolMaster();
