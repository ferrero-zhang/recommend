...
/**
 * <PRE>
 * 作用 : 解析userlog，获取追踪推荐等需要的操作日志，组装xml发送到solr和redis
 *   
 * 使用 : 
 *   
 * 示例 :
	...
	class PutThread extends Thread {
		...
		public void doWork() {
			...
			try{
				...
				int iNO = 0;
				List<SolrPojo> pojos = new ArrayList<SolrPojo>();//待输出数据对象
				...
				HashMap<String,String> date_value_map = new HashMap<String,String>();//初始操作数据
