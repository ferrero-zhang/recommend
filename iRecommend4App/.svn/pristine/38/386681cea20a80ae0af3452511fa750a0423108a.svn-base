...
public class ChineseCalendar {
	...
	/**
	 * Description: 1901-2100年中农历每年的月日信息，29天代表0,30天代表1
	 */
	  ...
	  /**
	   * Description: 1901-2050年中农历每年闰月的信息
	   */
...
//	    int iOffsetDays = iGetLNewYearOffsetDays(iYear, iMonth, iDay) + iSolarLunarOffsetTable[iYear - 1901];
	    int iOffsetDays = iGetLNewYearOffsetDays(iYear, iMonth, iDay) + iSolarLunarOffsetTable[iYear - 1901] - 1;
	   ...
	   * @return 除夕的阳历时间
	   */
	  static String sCalendarLundarToSolarFromChuXi(int iYear, int iMonth, int iDay) { 
	    int iSYear, iSMonth, iSDay; 
//	    int iOffsetDays = iGetLNewYearOffsetDays(iYear, iMonth, iDay) + iSolarLunarOffsetTable[iYear - 1901];
	    int iOffsetDays = iGetLNewYearOffsetDays(iYear, iMonth, iDay) + iSolarLunarOffsetTable[iYear - 1901] - 2;
	    int iYearDays = bIsSolarLeapYear(iYear) ? 366 : 365; 
